...
```{bash}
# jeśli chcemy to zrobić dla wszystkich obecnych i przyszłych repo 
git config --global user.name "DariuszMajerek"

# w moim przypadku ustalę te parametry tylko dla obecnego repo
# to dlatego że innego konta używam do swoich innych repo
git config user.name "DariuszMajerek"
```
