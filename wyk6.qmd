...
z danymi bez konieczności opuszczania interfejsu aplikacji[^2].

[^2]: cały przykład w postaci aplikacji Shiny można znaleźć pod adresem
    <https://github.com/dax44/ModelsDeployment/blob/master/upload.R>
